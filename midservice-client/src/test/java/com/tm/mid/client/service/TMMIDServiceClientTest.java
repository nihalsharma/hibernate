...
public class TMMIDServiceClientTest {
    ...
    public void getCompany(){
        MarketPlaceGetterClient getterService = new MarketPlaceGetterClient("http://localhost:8081/api/");
        Company company = getterService.getCompanyByMid(3);
        //{"id":6,"name":"abc","usersCount":10,"mid":3,"createdAt":"2014-09-15 19:02 PM IST","updatedAt":"2014-09-15 19:02 PM IST","active":true,"searchFeatureEnabled":true,"analyticsFeatureEnabled":false,"currency":"abc","domain":null,"source":"unknown","sourceDomain":null,"tierId":1}
        System.out.println(company.getMid());
    }

    @Test
    public void getAllWhiteListedCompanies(){
        MarketPlaceGetterClient getterService = new MarketPlaceGetterClient("http://localhost:8081/api/");
        HashMap<Integer, String> company = getterService.getAllWhiteListedCompanies();
        //{"1":"abc123","2":"abc123","3":"abc"}
